import { AriaProps, EditorCommand } from '@micro-text/editor';
import {
  DraftHandleValue,
  EditorState,
  genKey,
...
export class MentionSuggestions extends Component<MentionSuggestionsProps> {
  ...
  render(): ReactElement | null {
    ...
    if (popoverComponent || positionSuggestions) {
      warning(
        'The properties `popoverComponent` and `positionSuggestions` are deprecated and will be removed in @micro-text/mentions 6.0 . Use `popperOptions` instead'
      );
